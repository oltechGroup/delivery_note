...
function ModalDetalleTicket({ isOpen, onClose, ticketId }) {
  ...
  useEffect(() => {
    if (isOpen && ticketId) {
      ...
      // Limpiamos al cerrar
      setDetalle(null);
      setImagenExpandida(null); // Aseguramos que el visor se cierre si se cierra el modal
    }
  }, [isOpen, ticketId]);
              ...
              <div className="flex flex-col lg:flex-row divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
                ...
                <div className="flex-1 p-4 sm:p-6 space-y-6">
                  ...
                  {detalle.imagenes && detalle.imagenes.length > 0 && (
                    <div>
                      <h4 className="text-gray-800 font-bold mb-3 border-b pb-2 flex items-center space-x-2">
                        <span>Evidencia Adjunta ({detalle.imagenes.length})</span>
                        <span className="text-[10px] sm:text-xs font-normal bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full">(Click para ampliar)</span>
                      </h4>
